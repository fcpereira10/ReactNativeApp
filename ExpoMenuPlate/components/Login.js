    ...
    <StyleProvider style={getTheme(commonColor)}>
      <Container>
        ...
        <Content scrollEnabled={false}>
          <Form>
            <Item rounded>
              <Input placeholder='Email' onChangeText={handleEmailTextChange} />
            </Item>
            <Item rounded>
              <Input secureTextEntry={true} placeholder='Password' onChangeText={handlePasswordTextChange} />
            </Item>
            <Button rounded>
              <Text style={{ fontSize: 17 }} onPress={handleLogin}>Entrar</Text>
            </Button>
